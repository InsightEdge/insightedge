...
withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'insightedge-dev', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) {
    ...
    premiumDist = "$distributions -Ddist.xap=/home/jenkins/spark/gigaspaces-xap-premium-12.1.0-ga-b17000.zip"
    communityDist = "$distributions -Ddist.xap=/home/jenkins/spark/gigaspaces-xap-open-12.1.0-ga-b17000.zip"
