...
cp ${JOB_DIR}/insightedge-integration-tests/insightedge-integration-tests-jobs/target/insightedge-integration-tests-jobs*.jar ${JOB_DIR}/build/quickstart/scala/
EXIT_CODE=$?
echo "done job setup"
exit $EXIT_CODE
