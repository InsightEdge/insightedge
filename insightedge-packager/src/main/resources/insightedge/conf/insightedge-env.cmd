...
rem * For more information see https://docs.gigaspaces.com/latest/started/common-environment-variables.html     *
rem ***********************************************************************************************************
rem Source XAP environment;
call "%~dp0..\..\bin\setenv.bat"

rem Set InsightEdge defaults;
set INSIGHTEDGE_CLASSPATH=%GS_HOME%\insightedge\lib\*;%GS_HOME%\tools\jdbc\lib\*;%GS_HOME%\insightedge\lib\analytics-xtreme\*;%GS_HOME%\lib\required\*;%GS_HOME%\lib\optional\spatial\*
