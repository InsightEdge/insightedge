...
exit /B
:demo_gsm_found
echo Deploying space %INSIGHTEDGE_SPACE_NAME% with 2 partitions...
call "%XAP_HOME%\bin\gs" deploy-space -cluster schema=partitioned total_members=2 %INSIGHTEDGE_SPACE_NAME%
