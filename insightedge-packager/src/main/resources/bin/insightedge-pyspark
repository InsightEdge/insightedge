...
#
# This is an enhanced version of pyspark.py
#
...
# Load the InsighEdge version of shell.py script:
export OLD_PYTHONSTARTUP="$PYTHONSTARTUP"
export PYTHONSTARTUP="${SPARK_HOME}/bin/shell-init.py"
...
exec "${SPARK_HOME}"/bin/insightedge-submit pyspark-shell-main --name "PySparkShell" "$@"
